...
<body>
    <!-- iamgem principal da home e imagem abaixo  -->
    <div class="baanners">
        <img class="xuxu" src="img/bannerindex.png" alt="" />
        <img class="abobrinha" src="img/bannercompra.png" alt="" />
    </div>

    <!-- * titulo index  prod destaque -->
    ...
    <div class="container">
        ...
        // pega tudo de dentro da tabela cadprod e seleciona os item com o tipo: skatecompleto, e com visivel 1
        $sql = "SELECT * FROM cadprod WHERE tipo = 'skatecompleto' AND visivel = 1";
    ...
    <div class="titulo-paginas">
        <!-- titulo dos videos -->
        <h1>Assista Videos Sobre Skate!</h1>
    </div>

    <!-- videos exibidos na index -->
    <div class="videos-all">
        <video class="videos-index" src="../videos/COMO ANDAR DE SKATE DO ZERO_ - AULA COMPLETA 10 COISAS(360P).mp4" width="350px" height="250px" controls>
            Seu navegador não suporta a tag de vídeo.
        </video>
        <video class="videos-index" src="../videos/DIA 1 ATÉ DIA 3.650 APRENDENDO A ANDAR DE SKATE_(360P).mp4" width="350px" height="250px" controls>
            Seu navegador não suporta a tag de vídeo.
        </video>
    </div>
</body>
