...
<body>
    ...
    <div class="container">
        ...
        <?php
        require("conexao.php");
        // pega tudo de dentro da tabela cadprod e seleciona os item com o tipo: truck, e com visivel 1
        $sql = "SELECT * FROM cadprod WHERE tipo = 'truck' AND visivel = 1";
