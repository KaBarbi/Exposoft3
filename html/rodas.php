...
<header id="header">
    ...
    <nav id="nav">
        ...
        if (!isset($_SESSION['user'])) {
            ...
            echo "<div class='nav-buttons'>";
            echo "<a class='iconlb' href='../html/pedidos.php'><span class='material-icons' style='font-size: 37px'>account_circle</span></a>";
...
<body>
    ...
    <div class="container">
        ...
        <?php
        require("conexao.php");
        // pega tudo de dentro da tabela cadprod e seleciona os item com o tipo: roda, e com visivel 1
        $sql = "SELECT * FROM cadprod WHERE tipo = 'roda' AND visivel = 1";
    ...
    <!-- * titulo shapes/lixas -->
    <div class="titulo-paginas">
        <h1>Rolamentos mais Vendidos</h1>
    </div>
    ...
    <div class="container">
        ...
        $sql = "SELECT * FROM cadprod WHERE tipo = 'rolamento'";
        $qr = $mysql->query($sql) or die($mysql->error);
