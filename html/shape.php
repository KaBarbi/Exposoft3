...
<body>
    ...
    <div class="container">
        ...
        <?php
        require("conexao.php");
        // pega tudo de dentro da tabela cadprod e seleciona os item com o tipo: shape, e com visivel 1
        $sql = "SELECT * FROM cadprod WHERE tipo = 'shape' AND visivel = 1";
    ...
    <div class="container">
        ...
        $sql = "SELECT * FROM cadprod WHERE tipo = 'lixa'";
        $qr = $mysql->query($sql) or die($mysql->error);
